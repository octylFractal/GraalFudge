...
@GenerateWrapper
@ReportPolymorphism
public abstract class WutlangStatementNode extends Node implements InstrumentableNode {
    private final SourceSection sourceSection;
    @CompilerDirectives.CompilationFinal
    private TruffleLanguage.ContextReference<WutlangContext> context;

    protected WutlangStatementNode(SourceSection sourceSection) {
    ...
    public WrapperNode createWrapper(ProbeNode probeNode) {
        return new WutlangStatementNodeWrapper(this.sourceSection, this, probeNode);
    }
